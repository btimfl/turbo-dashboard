            ...
            <form onSubmit={formik.handleSubmit} className={styles.form}>
                <Box>
                    ...
                    <FormControl mb={4} isInvalid={formik.touched.email && !!formik.errors.email}>
                        <FormLabel ps={4} htmlFor="email">Email Id</FormLabel>
                        <Input type="text" placeholder="johndoe@company.com" aria-placeholder="johndoe@company.com" {...formik.getFieldProps('email')}></Input>
                    ...
                    <Flex justifyContent="center">
                        <Button w="10rem" type='submit' color='white' background='rgb(101,87,245)' marginInline="auto">Sign in</Button>
                    </Flex>
                </Box>
            </form >
        </Box >
